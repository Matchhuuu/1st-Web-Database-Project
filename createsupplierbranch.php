...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "INSERT INTO supplierbranch (ProductID, Product, PricePerProduct, SupplierName, SupplierBranch, Quantity, DeliveredAt) " .
...
<div class="container my-5">
    <a class="btn btn-primary mb-3" href="/myshop/supplier.php" role="button">Product List</a>
