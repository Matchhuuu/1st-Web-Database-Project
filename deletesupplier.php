            ...
            <body>
                <div class='container my-5'>
                    <div class='alert alert-warning'>
                        ...
                        <hr>
                        <div class=''>
                            <a href='/myshop/deletesupplier.php?id=$id&confirm=true' class='btn btn-danger'>Yes, Delete</a>
                            <a href='/myshop/supplierorders.php' class='btn btn-secondary'>Cancel</a>
                        </div>
                    </div>
                </div>
            </body>
