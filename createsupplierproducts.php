...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        $errorMessage = "Product with the same name or supplier name already exists.";
    } else {
        // Add new product to the database
        $sql = "INSERT INTO supplierproducts (ProductID, Product, PricePerProduct, SupplierName, Quantity, DeliveredAt) " .
            "VALUES ('$ProductID', '$Product', '$PricePerProduct', '$SupplierName', '$Quantity', '$DeliveredAt')";
        $result = $connection->query($sql);
...
<div class="container my-5">
    <a class="btn btn-primary mb-3" href="/myshop/supplierorders.php" role="button">Product List</a>
    ...
    <form method="post">
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label">DeliveredAt</label>
            <div class="col-sm-6">
